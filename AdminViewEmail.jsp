                    ...
                    <ul class="flex-column mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul id="MenuDropdown" class="sub-navbar collapse flex-column">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/staffController?action=displayAllStaff">View Email <span class="sr-only">(current)</span></a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                    ...
                    <article>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><button type="submit" class="btn btn-success"><a href="${pageContext.request.contextPath}/adminController?action=updateStaff&STAFFID=${Staff.STAFFID}">Update</a></button></td>
                                <td><button type="submit" class="btn btn-danger" onclick="return confirm('Confirm Delete this Data?')"><a href="${pageContext.request.contextPath}/adminController?action=deleteStaff&STAFFID=${Staff.STAFFID}">Delete</a></button></td>
                            </tr>
                            </c:forEach>
                            </tbody>
                        </table>
