                    ...
                    <ul class="flex-column mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul id="Dropdown" class="sub-navbar collapse flex-column">
                                <li class="nav-item active"><a class="nav-link" href="AdminCreateAdmin.jsp">Create New Admin <span class="sr-only">(current)</span></a></li>
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/adminController">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ADMID" pattern="[0-9]+" title="Numbers only" required>
                                </div>

                                <div class="form-group">
                                    <label for="ADMNAME">Name</label>
                                    <input type="text" class="form-control" name="ADMNAME" pattern="[a-zA-Z ]+" title="Character only" style="text-transform:lowercase;" required>
                                </div>

                                <div class="form-group">
                                    <label for="ADMIC">IC</label>
                                    <input type="text" class="form-control" name="ADMIC" pattern="[0-9]{12}"  maxlength="12" title="020425045889" required>
                                </div>

                                <div class="form-group">
                                    <label for="ADMPHONE">Phone</label>
                                    <input type="text" class="form-control" name="ADMPHONE"  pattern="[0-9]+" title="Numbers only" required>
                                </div>

                                <div class="form-group">
                                    <label for="ADMUSERNAME">Username</label>
                                    <input type="text" class="form-control" name="ADMUSERNAME" required>
                                </div>

                                <div class="form-group">
                                    <label for="ADMPASSWORD">Password</label>
                                    <input type="text" class="form-control" name="ADMPASSWORD"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
