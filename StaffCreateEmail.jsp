            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <article>
                        ...
                        <blockquote><p>Please fill in the form below by entering your personal information.
                        Please be note that after the registration is complete, you will need to login by using
                        the password given before able to access the system.</p></blockquote>

                        <p>&nbsp;</p>

                        <form method="post" action="${pageContext.request.contextPath}/staffController">
